...
export const ListPagination = ({
  ...
  const { hasPreviousPage, hasNextPage, page, perPage, setPerPage, total, setPage } = useListPaginationContext();
        ...
        <PaginationContent>
          <PaginationItem>
            <PaginationLink
              ...
              className={cn("gap-1 px-2.5 sm:pr-2.5", !hasPreviousPage ? "opacity-50 cursor-not-allowed" : "")}
          ...
          {startPages.map((pageNumber) => (
            <PaginationItem key={pageNumber}>
              <PaginationLink href="#" onClick={pageChangeHandler(pageNumber)} isActive={pageNumber === page}>
                {pageNumber}
              </PaginationLink>
            </PaginationItem>
          ))}
          ...
          <PaginationItem>
            <PaginationLink
              ...
              onClick={pageChangeHandler(page + 1)}
              size="default"
              className={cn("gap-1 px-2.5 sm:pr-2.5", !hasNextPage ? "opacity-50 cursor-not-allowed" : "")}
