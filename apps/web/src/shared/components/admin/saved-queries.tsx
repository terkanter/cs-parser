...
import { extractValidSavedQueries, useSavedQueries } from "@/shared/hooks/saved-queries";
      ...
      <DialogContent className="sm:max-w-[425px]">
        ...
        <form onSubmit={handleFormSubmit} className="space-y-4">
          <div className="space-y-2">
            ...
            <Input id="name" value={queryName} onChange={handleQueryNameChange} autoFocus />
          </div>
        </form>
        <DialogFooter>
...
export const RemoveSavedQueryDialog = ({ open, onClose }: RemoveSavedQueryDialogProps): ReactElement => {
  const translate = useTranslate();
