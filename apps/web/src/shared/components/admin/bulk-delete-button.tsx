...
export interface BulkDeleteButtonProps<RecordType extends RaRecord = any, MutationOptionsError = unknown>
...
export const BulkDeleteButton = <RecordType extends RaRecord = any, MutationOptionsError = unknown>(
  ...
  const { mutationMode = "undoable", icon = defaultIcon, label, className, mutationOptions = {} } = props;
