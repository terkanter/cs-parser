...
import { type ChoicesProps, FieldTitle, type InputProps, useChoices, useChoicesContext, useInput } from "ra-core";
          ...
          {allChoices?.map((choice) => {
            ...
            return (
              <div key={value} className="flex items-center space-x-2">
                ...
                <Label
                  htmlFor={`${id}-${value}`}
                  className={cn("text-sm font-normal cursor-pointer", isDisabled && "opacity-50 cursor-not-allowed")}
                >
