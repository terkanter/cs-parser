...
export const Breadcrumb = ({ children, ref }: BreadcrumbProps) => {
  ...
  return createPortal(
    <>
      <Separator decorative orientation="vertical" className="data-[orientation=vertical]:h-4 mr-4" />
                ...
                <Drawer open={open} onOpenChange={setOpen}>
                  ...
                  <DrawerContent>
                    <DrawerHeader className="text-left">
                      <DrawerTitle>
                        <Translate i18nKey="ra.navigation.breadcrumb_drawer_title">Navigate to</Translate>
                      </DrawerTitle>
                      <DrawerDescription>
