...
const SortButtonComponent = (props: SortButtonProps) => {
  const { fields, label = "ra.sort.sort_by", icon = defaultIcon, resource: resourceProp, ...rest } = props;
...
const arePropsEqual = (prevProps: any, nextProps: any) => shallowEqual(prevProps.fields, nextProps.fields);
