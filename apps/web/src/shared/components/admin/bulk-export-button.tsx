...
import { type RaRecord, Translate, type UseBulkExportOptions, useBulkExport } from "ra-core";
 ...
 *
 * @example // basic usage
 * import { BulkDeleteButton, BulkExportButton, DataTable, List } from '@/shared/components/admin';
 *
