 ...
 *
 * @example
 * import { FileField } from '@/shared/components/admin/file-field';
 *
...
>(
  ...
  const { className, empty, title, src, target, download, defaultValue, source, record, ...rest } = props;
