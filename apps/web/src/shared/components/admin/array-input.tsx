...
import { FormError, FormField } from "@/shared/components/admin/form";
  ...
  return (
    ...
    >
      <Label className="text-muted-foreground text-sm">
        <FieldTitle label={label} source={arraySource} resource={resourceFromProps} isRequired={isRequired(validate)} />
      </Label>
